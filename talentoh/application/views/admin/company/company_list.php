        ...
        <div class="form-body">
          ...
          <div class="row">
            ...
            <!--  <label for="email"><?php // echo $this->lang->line('dashboard_username');?></label> -->
              <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_username');?>" name="username" type="hidden">
            </div>
            <div class="col-md-3">
              <!--  <label for="website"><?php //echo $this->lang->line('xin_employee_password');?></label>-->
              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_password');?>" name="password" type="hidden">
            </div>
