    ...
    <div class="media-body ml-5">
      ...
      <div class="text-muted mb-4">
        ...
        <div class="col-md-2">
          ...
          <div class="btn-group hidden-md-down" role="group" aria-label="Basic example"> <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_save').' Imagen de Cabecera')); ?> </div>
        </div>
        <?php echo form_close(); ?>
        <?php endif; ?>
      </div>
