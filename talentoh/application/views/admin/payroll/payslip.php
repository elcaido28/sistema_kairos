  ...
  <div class="col-md-12">
    <div class="card mb-4">
      <div class="card-header with-elements"> <span class="card-header-title mr-2"><?php echo $this->lang->line('xin_payslip');?> - </strong><?php echo date("F, Y", strtotime($payment_date));?></span>
        <div class="card-header-elements ml-md-auto"> <a href="<?php echo site_url();?>admin/payroll/pdf_create/<?php echo $gd;?>/<?php echo $make_payment_id;?>/" class="btn btn-social-icon mb-1 btn-outline-github" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $this->lang->line('xin_pdf');?>"><i class="far fa-file-pdf d-block text-danger"></i> Exportar a PDF</a> </div>
      </div>
      <div class="card-body">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              ...
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
                  <?php if($overtime_rate!=0 || $overtime_rate!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('xin_payroll_gross_salary');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($salario_bruto);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($total_ingresos!=0 || $total_ingresos!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('xin_payroll_total_allowance');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($total_ingresos);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($total_egresos!=0 || $total_egresos!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('xin_payroll_total_deduction');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($total_egresos);?></span></td>
                  </tr>
                  <?php endif;?>
                  <?php if($salario_neto!=0 || $salario_neto!=''):?>
                  <tr>
                    <td><strong><?php echo $this->lang->line('xin_payroll_net_salary');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($salario_neto);?></span></td>
                  </tr>
                  <?php endif;?>
